                ...
                <div class="container-fluid">
                    <div class="row py-2 mb-3 bg-body-tertiary shadow rounded justify-content-evenly">
                        ...
                        <div class="col-md-2 col-sm-12 mb-3 d-flex align-items-center">
                            <div class="w-100 h-auto position-relative cover-image-action-btn-hover-cover p-md-2 p-sm-5 rounded-circle bg-body-secondary shadow">
                                <img src="..." class="img-fluid rounded-top w-100" alt=""
                                    id="student__cover_img-preview"
                        ...
                        <div class="col-md-9 col-sm-12 mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <x-partials.form-input label="Student Mobile" name="student__mobile" placeholder="Student Mobile" required="true" type="text" />
                                </div>
                                <div class="col">
                                    <x-partials.form-input label="Student Email" name="student__email" placeholder="Student Email" required="true" type="email" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                    ...
                    <div class="row py-2 mb-3 bg-body-tertiary shadow rounded justify-content-evenly">
                        ...
                        <div class="col-11">
                            {{-- todo: use tom-select with separate table to handle guardian info g(1) - s(m) --}}
                            <x-partials.form-input label="Name" name="guardian_name" placeholder="Guardian Name" required="true" type="text" />
                            <x-partials.form-input label="Address" name="guardian_address" placeholder="Guardian Address" required="true" type="text" />
                            <x-partials.form-input label="Mobile" name="guardian_mobile" placeholder="Guardian Mobile" required="true" type="text" />
                        </div>
                    </div>
                </div>
            </div>
